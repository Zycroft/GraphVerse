...
def main():
    ...
    training_data, vocab = prepare_training_data(
        G, num_samples=10, min_length=10, max_length=50, rules=rules)
    ...
    print("\nEvaluation Results:")
    print(f"Average rule violations: {
          df_results['rule_violations'].mean():.2f}")
    print(f"Average generated walk length: {
          df_results['generated_length'].mean():.2f}")
